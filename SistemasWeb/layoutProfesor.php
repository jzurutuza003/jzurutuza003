...
<html>
  ...
  <div id='page-wrap'>
	...
	<nav class='main' id='n1' role='navigation'>
		<span><a href='#' onclick="verUsuarios()">Ver Usuarios</a></span>
		<span><a href='#' onclick="verPreguntas()">Ver Preguntas</a></span>
		<span><a href='#' onclick="insertarPreguntas()">Insertar Preguntas</a></span>
		<span><a href='#' onclick="revisar()">Gestionar Preguntas</a></span>
		<span><a href='#' onclick="creditos()">Creditos</a></span>
	</nav>
    <section class="main" id="s1">
		<iframe id="verUsuarios" src="VerUsuariosConFoto.php" style="display:none; border:0px; height: 400px; width: 100%"></iframe>
		...
		<iframe id="revisar" src="RevisarPreguntas.php" style="display:none; border:0px; height: 400px; width: 100%"></iframe>

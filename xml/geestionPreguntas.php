...
if($_SESSION['logueado']=='1'){
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		function insertarPregunta(str){
			xmlhttp.open("POST","InsertarPregunta.php?c="+str,true);
			...
			xmlhttp.send('$Pregunta'+document.getElementById('correo'),'$Respuesta'+document.getElementById('pass'),'$Tematica'+document.getElementById('p'),'$Valoracion'+pppp);
		}
		</script>
		</head>
		<body
		...
		<form  method="post" id='formulario' >
			<div id='login'>
				...
				<p id='p3'><input type='button' id='boton' value='Insertar' onClick="insertarPregunta('formulario')"></p>
			</div>

...
if(filter_var($correo, FILTER_VALIDATE_REGEXP, array("options" => array("regexp" => "/^[a-z]+\d{3}@ikasle\.ehu\.(es|eus)$/"))) === FALSE){
...
mysql_select_db("u878461769_mysql",$usu);
 ...
 if ($count == 1){ 
	...
	$SQL1=" INSERT INTO usuario VALUES('$usuario', '$Password','$correo','$Telefono','$Especialidad','$Especialidad_alternativa','$Comentario',1)";
	if (!mysql_query($SQL1))
		{
